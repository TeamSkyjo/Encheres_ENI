...
public class PickupDAOImpl implements PickupDAO {
    ...
    public void create(Pickup pickup) {
        MapSqlParameterSource mapSqlParameterSource = getSource(pickup);
    ...
    private static MapSqlParameterSource getSource(Pickup pickup) {
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource();
        mapSqlParameterSource.addValue("no_article", pickup.getArticle().getArticleId());
